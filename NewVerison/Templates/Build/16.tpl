...
//UPDATE s1_movement set proc = 1 where proc = 0 and moveid = 965
//6,80805,80802,0,1331136586,1331136591array(33) 
...
//		  var_dump($enforce);
		  ...
		  if ($tribe!=4){$sendbacklink="<a href='a2b.php?w=".$enforce['id']."'>Send back</a>";}
                  echo "</tr></tbody>
            <tbody class=\"infos\"><tr><th>Upkeep</th><td colspan=\"10\"><div class='sup'>".$technology->getUpkeep($enforce,$tribe)."<img class=\"r4\" src=\"img/x.gif\" title=\"Crop\" alt=\"Crop\" />per hour</div><div class='sback'>".$sendbacklink."</div></td></tr>";
