...
//echo($units[0]['starttime']+180).">".time();
//var_dump($units[$y]);
if (($units[$y]['starttime']+180)>time()){

$canceltroops='<div class="abort"><a href="build.php?id='.$_GET['id'].'&mode=troops&cancel=1&moveid='.$units[$y]['moveid'].'"><img src="img/x.gif" class="del" title="Annuleren" alt="Annuleren" /></a>';
