...
if ($units[$y]['sort_type']==3){
	if ($units[$y]['attack_type']==3){
		...
		$actionType = ''.ARRIVING_REINF_TROOPS_SHORT.'';
		$img="biga.gif";
	}
	...
	if($units[$y]['attack_type'] != 1){
		echo "<table class=\"troop_details\" cellpadding=\"1\" cellspacing=\"1\"><thead><tr><td class=\"role\">
                  ...
                  <td colspan=\"9\">";
                  echo "<a href=\"spieler.php?uid=".$database->getVillageField($units[$y]['from'],"owner")."\">$actionType ".$database->getUserField($database->getVillageField($units[$y]['from'],"owner"),"username",0)."'s troops </a>";
                  echo "</td><td><img src=\"../../img/anim/$img\" width=\"30\" height=\"30\"/></td></tr></thead><tbody class=\"units\">";
