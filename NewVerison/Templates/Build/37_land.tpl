...
<tr>
<td class="nam">
<a href="build.php?a=37&gid=37&c=016&del=374&land=<?php echo $oasisarray[$i]['wref']; ?>"><img class="del" src="img/x.gif" alt="delete" title="delete"></a>
...
<?php
    ...
    $land =$_GET['land'];
	$q= mysql_query("update ".TB_PREFIX."odata set `conqured`='0', `owner`='2', `name`='Unoccupied Oasis', `lastupdated`='".time()."', `loyalty`='100' where `wref`='".$land."'");
	mysql_query($q);
    echo "Done";
    }
?>