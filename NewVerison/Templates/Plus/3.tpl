...
?>
            ...
            <td class="cost"><img src="img/x.gif" class="gold" alt="Gold" title="Gold" alt="Gold" title="Gold" /><?php echo G_PLUS; ?> </td>
            <td class="act">
...
&nbsp;    </span>
            ...
            <td class="cost"><img src="img/x.gif" class="gold" alt="Gold" title="Gold" /><?php echo G_LUMBER; ?></td>
...
&nbsp;    </span>
            ...
            <td class="cost"><img src="img/x.gif" class="gold" alt="Gold" title="Gold" /><?php echo G_CLAY; ?></td>
...
&nbsp;    </span>
            ...
            <td class="cost"><img src="img/x.gif" class="gold" alt="Gold" title="Gold" /><?php echo G_IRON; ?></td>
            <td class="act"><span class="none">
...
&nbsp;    </span>            </td>
            ...
            <td class="cost"><img src="img/x.gif" class="gold" alt="Gold" title="Gold" /><?php echo G_CROP; ?></td>
            <td <span class="none">
<?php
...
?>
        ...
        <tr>
            ...
            <td class="dur">now</td>
            <td class="cost"><img src="img/x.gif" class="gold" alt="Gold" title="Gold" /><?php echo G_COMPLETE; ?></td>
            <td class="act"><span class="none">
...
if (mysql_num_rows($MyGold)) {
 ...
 ?>
        ...
        <tr>
            ...
            <td class="dur">now</td>
            <td class="cost"><img src="img/x.gif" class="gold" alt="Gold" title="Gold" /><?php echo G_TRADE; ?></td>

            <td class="act"><span class="none">

 <?php
if (mysql_num_rows($MyGold)) {
    if($golds['gold'] > G_TRADE) {
...
<tr>
        ...
        <td class="desc">Buy 250 Pop for <u>any</u> Village</td>
        <td class="dur">now</td>
...
<tr>
        <td class="man"><a href="#"><img class="help" src="img/x.gif" alt="" title="" /></a></td>
        <td class="desc">Complete queueing troops in <u>any</u> Village</td>
        <td class="dur">now</td>
        <td class="cost"><img src="img/x.gif" class="gold" alt="Gold" title="Gold" /><?php echo G_TRAIN; ?></td>
        <td class="act"><span class="none">
<?php
if (mysql_num_rows($MyGold)) {
    if($golds['gold'] > G_TRAIN-1) {
    echo '
                <a href="buytroops.php"><span>Go';
} else {
    echo '<a href="plus.php?s=1"><span class="none">too little gold';
    }
}
...
<tr>
        <td class="man"><a href="#"><img class="help" src="img/x.gif" alt="" title="" /></a></td>
        <td class="desc">Buy 100k Wood, Clay, Iron, Crop for <u>any</u> Village</td>
        <td class="dur">now</td>
...
if (mysql_num_rows($MyGold)) {
    if($golds['gold'] > 99) {
    echo '
                <a href="buyresources.php"><span>Go';
} else {
    echo '<a href="plus.php?s=1"><span class="none">too little gold';
    }
}
...
<tr>
        <td class="man"><a href="#"><img class="help" src="img/x.gif" alt="" title="" /></a></td>
        <td class="desc">Buy <u>any amount</u> of Resources. <?php echo G_RESOURCE; ?> Gold = 1000 Resources</td>
        <td class="dur">now</td>
        <td class="cost">From <img src="img/x.gif" class="gold" alt="Gold" title="Gold" /><?php echo G_RESOURCE; ?></td>
        <td class="act"><span class="none">
<?php
if (mysql_num_rows($MyGold)) {
    if($golds['gold'] > G_RESOURCE) {
    echo '
                <a href="buyresources2.php"><span>Go';
} else {
    echo '<a href="plus.php?s=1"><span class="none">too little gold';
    }
}
...
<tr> 
        ...
        <td class="man"><a href="#"><img class="help" src="img/x.gif" alt="" title="" /></a></td>
        <td class="desc">Buy Artworks (2500CP)</td>
        <td class="dur">now</td>
        <td class="cost"><img src="img/x.gif" class="gold" alt="Gold" title="Gold" /><?php echo G_ARTWORK; ?></td>
        <td class="act"><span class="none">
<?php
if (mysql_num_rows($MyGold)) {
    if($golds['gold'] > G_ARTWORK) {
    echo '
                <a href="artworks.php"><span>Go';
} else {
    echo '<a href="plus.php?s=1"><span class="none">too little gold';
    }
}
