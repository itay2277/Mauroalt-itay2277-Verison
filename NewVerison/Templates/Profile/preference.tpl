...
<form action="spieler.php?s=2" method="POST">
  ...
  <table cellpadding="1" cellspacing="1" id="links">
    ...
    <tbody>
	 ...
	 <td>
	<!--delete link -->
	<a href="spieler.php?s=2&link=<?php echo $link['id']; ?>"><img class="del" src="img/x.gif" alt="delete" title="delete"></a>
	<!-- //end fix -->
	</td         
      ></tr>
...
<?php
    ...
    $link =$_GET['link'];
	$q= mysql_query("DELETE FROM ".TB_PREFIX."links WHERE `id`='".$link."'");
	mysql_query($q);
