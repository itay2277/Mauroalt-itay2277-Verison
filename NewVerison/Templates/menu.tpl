...
<body>
    <div id="side_navi">
        <a id="logo" href="<?php echo HOMEPAGE; ?>" name="logo"><img src="img/x.gif" alt="<?php echo SERVER_NAME; ?>"></a>
    ...
    <div id="side_navi">
        ...
        <p><a href="<?php echo HOMEPAGE; ?>"><?php echo HOME; ?></a> <a href="spieler.php?uid=<?php echo $session->uid; ?>"><?php echo PROFILE; ?></a> <a href="#" onClick="return Popup(0,0,1);"><?php echo INSTRUCT; ?></a> <?php if($session->access == MULTIHUNTER) {
		   ...
		   // echo "<a href=\"admin_create.php\"><font color=\"blue\">Create Admin</font></a>";
        ...
        <p><a href="plus.php?id=3"><?php echo SERVER_NAME; ?> <b><span class="plus_g">P</span><span class="plus_o">l</span><span class="plus_g">u</span><span class="plus_o">s</span></b></a>
                    <P>
					<a href="<?php echo HOMEPAGE; ?>forum"><b>Forum <?php echo SERVER_NAME; ?></b></a>
					<a href="spieler.php?uid=0"><b>Support</b></a>
					<a href="rules.php"><b>Game Rules</b></a></P>
        <br></p>
		...
		if($timestamp) {
			echo "<span span class=\"plus_o\">";

			$time=$generator->getTimeFormat(($timestamp-time()));
       		echo "The account will be deleted in <span id=\"timer2\">".$time."</span></span>";
		}
    ...
    <div id="content" class="village1">
        <h1><?php echo ANNONCEMENT; ?></h1>

        <h2>Ciao <?php echo $session->username; ?>,</h2>
        <br>
