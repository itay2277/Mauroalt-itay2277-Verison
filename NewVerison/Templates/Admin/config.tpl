...
<br/>
<br/>
<br/><img src="icon/configure32.png" alt="Config" />
<br/>
<table id="member">
  <thead>
    <tr>
...
<table id="profile">    
 ...
 <tr>
	...
	<tr>
        ...
        <td><?php echo STORAGE_MULTIPLIER;?>x</td>    
    </tr>
		<tr>
...
<table id="member">
  ...
  <tr>
	...
	<tr>
		...
		<td>End training troops</td>
		
		<td><?php if(ACTIVATE1 == true){
				echo "<b><font color='Green'>Enabled</font></b>";
				}
				else if(ACTIVATE1 == false){
				echo "<b><font color='Red'>Disabled</font></b>";
				} ?> </td>
	...
	<tr>
		...
		<td><?php if(ACTIVATE2 == true){
				echo "<b><font color='Green'>Enabled</font></b>";
				}
				else if(ACTIVATE2 == false){
				echo "<b><font color='Red'>Disabled</font></b>";
				} ?> </td>
	...
	<tr>
		...
		<td>Buy Culture Point</td>
		
		<td><?php if(ACTIVATE3 == true){
				echo "<b><font color='Green'>Enabled</font></b>";
				}
				else if(ACTIVATE3 == false){
				echo "<b><font color='Red'>Disabled</font></b>";
				} ?> </td>
...
<table id="profile">  
  ...
  <tr>
	...
	<td><?php if(ADMIN_EMAIL == ''){
				...
				echo "codice non ancora implementato";
				} ?></td>
	</tr>
</table>	
