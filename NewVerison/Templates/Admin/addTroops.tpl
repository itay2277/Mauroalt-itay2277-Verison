...
<table id="member">
	...
	<tr>
        <td><img src="../img/un/u/hero.gif"></img> <?php echo Hero; ?></td>
		<td><input class="addTroops" name="hero" id="hero" value="<?php echo $units['hero']; ?>" maxlength="10">&nbsp;&nbsp;&nbsp;<font color="#bcbcbc" size="1">Currently: <b><?php echo $units['hero']; ?></b><font></td>
    </tr>
