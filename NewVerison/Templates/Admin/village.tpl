...
<?php if($_SESSION['access'] == ADMIN){ echo '<div align="right"><a href="admin.php?p=addResource&did='.$id.'">Edit resource</div></a>'; 
	} else if($_SESSION['access'] == MULTIHUNTER){ echo '<a href="#"><b><div align="right"><font color="#bcbdbc">Edit resource</font></div></a></b>'; } 
	?>
...
<?php
$query = mysql_query("SELECT * FROM ".TB_PREFIX."odata WHERE conqured = ".$id."");




while($oasi_array = mysql_fetch_array($query)){

$coordinate = mysql_query("SELECT * FROM ".TB_PREFIX."wdata WHERE id = ".$oasi_array['wref']."");
$oasi_coord= mysql_fetch_array($coordinate);
//var_dump($oasi_coord);
?>
    <tr>

        <td><a href="?delOas&oid=<?php echo $oasi_array['wref']; ?>"><img src="../img/admin/del.gif"></a></td>

        <td class="hab"><?php echo $oasi_array['name']; ?></td>

        <td class="hab"><?php echo "(". $oasi_coord['x']."|".$oasi_coord['y'].")"; ?> </td> 

        <td class="hab"><?php echo $oasi_array['loyalty']; ?></td>  

        <td class="hab"><?php switch($oasi_array['type']) {
		case 1:
		case 2:
...
<table id="member">
    ...
    <tr>
        ...
        <th colspan="11">Troops in village</th>
		<?php
#== Romans ==#          
#========================================
if($units['u1'] == 0){
...
#======================================== 
if($units['hero'] == 0){
$hero = '<font color="gray">'.$units['hero'].'';
}
else if($units['hero'] > 0){
$hero = '<font color="black">'.$units['hero'].'';
}
#======================================== 
?>
...
echo '
    ...
    <tr>
		...
		<td><center /><img src="../img/un/u/hero.gif"></img></td>
    </tr>
...
<?php if($_SESSION['access'] == ADMIN){ 
echo '<div align="right"><a href="admin.php?p=trainTroops&did='.$id.'">Train troops</div></a>';
echo '<div align="right"><a href="admin.php?p=addTroops&did='.$id.'">Edit troops</div></a>'; 
