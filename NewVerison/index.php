...
\** --------------------------------------------------- **/
       ...
       //include ("GameEngine/Lang/en.php"); //fix lingua
                ...
                <div class="secondarybox">
                    ...
                    <div id="newsbox">
                        ...
                        <?php
							...
							if ($time_left > 0){
							 echo ("<center><big>Server will start in: <b><font color=red><span id=\"timer1\">".date('H:i:s', $time_left+0*3600)."</span></font></b></big></center>");   
