...
#################################################################################
        ...
        class Process {
        	...
        	function constForm() {
				...
				$text = preg_replace("'%STARTTIME%'", $_POST['start'], $text);
				...
				$text = preg_replace("'%A_GOLD%'", $_POST['all_gold'], $text);
				$text = preg_replace("'%G_PLUS%'", $_POST['g_plus'], $text);
				$text = preg_replace("'%G_LUMBER%'", $_POST['g_lumber'], $text);
				$text = preg_replace("'%G_CLAY%'", $_POST['g_clay'], $text);
				$text = preg_replace("'%G_IRON%'", $_POST['g_iron'], $text);
				$text = preg_replace("'%G_CROP%'", $_POST['g_crop'], $text);
				$text = preg_replace("'%G_COMPLETE%'", $_POST['g_complete'], $text);
				$text = preg_replace("'%G_TRADE%'", $_POST['g_trade'], $text);
				$text = preg_replace("'%G_TRAIN%'", $_POST['g_train'], $text);
				$text = preg_replace("'%ACTIVATE1%'", $_POST['activate1'], $text);
				$text = preg_replace("'%G_RESOURCE%'", $_POST['g_resource'], $text);
				$text = preg_replace("'%ACTIVATE2%'", $_POST['activate2'], $text);
				$text = preg_replace("'%G_ARTWORK%'", $_POST['g_artwork'], $text);
				$text = preg_replace("'%ACTIVATE3%'", $_POST['activate3'], $text);
				$text = preg_replace("'%R_GOLD%'", $_POST['r_gold'], $text);
				$text = preg_replace("'%ACTIVATE4%'", $_POST['activate4'], $text);
