...
// ***** COST PLUS GOLD
// ***** GOLD START ALL USER
define("A_GOLD", %A_GOLD%);
// ***** ACCOUNT PLUS
define("G_PLUS", %G_PLUS%);
// ***** 25% LUMBER
define("G_LUMBER", %G_LUMBER%);
// ***** 25% CLAY
define("G_CLAY", %G_CLAY%);
// ***** 25% IRON
define("G_IRON", %G_IRON%);
// ***** 25% CROP
define("G_CROP", %G_CROP%);
// ***** COMPLETE COSTRUTION
define("G_COMPLETE", %G_COMPLETE%);
// ***** TRADE NPC
define("G_TRADE", %G_TRADE%);

//////////////////////////////////
//    EXTRA PLUS OPTION         //
//////////////////////////////////
// ***** COMPLETE TRAIN TROOPS
define("G_TRAIN", %G_TRAIN%);
// ***** ACTIVE COMPLETE TRAIN TROOPS
define("ACTIVATE1",%ACTIVATE1%);

// ***** BY RESOURCE
define("G_RESOURCE", %G_RESOURCE%);
// ***** ACTIVE BY RESOURCE
define("ACTIVATE2",%ACTIVATE2%);

// ***** BY ARTWORK - CULTURE POINT
define("G_ARTWORK", %G_ARTWORK%);
// ***** ACTIVE BY RESOURCE
define("ACTIVATE3",%ACTIVATE3%);

// ***** BONUS REF LINK
define("R_GOLD", %R_GOLD%);
// ***** VILLAGE 
define("ACTIVATE4",%ACTIVATE4%);
