...
--
-- Host: localhost
-- Generato il: Mar 16, 2012 alle 18:14
...
--
-- Struttura della tabella `%PREFIX%gold_log`
--

CREATE TABLE IF NOT EXISTS `%PREFIX%gold_log` (
...
--
-- Struttura della tabella `%PREFIX%alidata`
--
...
--
-- Struttura della tabella `%PREFIX%allimedal`
--
...
--
-- Struttura della tabella `%PREFIX%artefacts`
--
...
--
-- Struttura della tabella `%PREFIX%attacks`
--
...
--
-- Struttura della tabella `%PREFIX%links`
--
...
--
-- Struttura della tabella `%PREFIX%login_log`
--
...
CREATE TABLE IF NOT EXISTS `%PREFIX%ndata` (
  ...
  `allyto` int(10) unsigned NOT NULL,
  `allyfrom` int(10) unsigned NOT NULL,
  `uaid` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
