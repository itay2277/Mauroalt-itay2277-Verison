...
<h1><?php echo LOGOUT_END;?></h1><img class="roman" src="img/x.gif" alt=""><p><?php echo THANKS;?></p>

		<p><?php echo COOKIES_LOGOUT;?><br /><a href="login.php?del_cookie">&raquo; <?php echo COOKIES_DELETE;?></a></p>
</div>
