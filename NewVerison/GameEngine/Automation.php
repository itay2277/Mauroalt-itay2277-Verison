   ...
   return round($dist, 1);
    ...
    private function pruneResource() {
        ...
        if(!ALLOW_BURST) {
            ...
            $database->query($q);
//            $q = "UPDATE ".TB_PREFIX."vdata set `crop` = 0 WHERE `crop` < 0";
//            $database->query($q);
...
//			var_dump($data);
			//array(32) { ["moveid"]=> string(1) "7" ["sort_type"]=> string(1) "3" ["from"]=> string(5) "80802" ["to"]=> string(5) "80402" ["ref"]=> string(1) "3" ["endtime"]=> string(10) "1328487794" ["proc"]=> string(1) "0" ["id"]=> string(1) "3" ["vref"]=> string(5) "80802" ["t1"]=> string(3) "250" ["t2"]=> string(1) "0" ["t3"]=> string(1) "0" ["t4"]=> string(1) "0" ["t5"]=> string(1) "0" ["t6"]=> string(1) "0" ["t7"]=> string(1) "0" ["t8"]=> string(1) "0" ["t9"]=> string(1) "0" ["t10"]=> string(1) "0" ["t11"]=> string(1) "1" ["attack_type"]=> string(1) "4" ["ctar1"]=> string(1) "0" ["ctar2"]=> string(1) "0" ["spy"]=> string(1) "0" ["b1"]=> string(1) "0" ["b2"]=> string(1) "0" ["b3"]=> string(1) "0" ["b4"]=> string(1) "0" ["b5"]=> string(1) "0" ["b6"]=> string(1) "0" ["b7"]=> string(1) "0" ["b8"]=> string(1) "0" }
...
//echo "///".count($database->getEnforceVillage($data['to'],0))."///";
...
//						var_dump($to);
/*						array(40) { [0]=> string(5) "80402" ["id"]=> string(5) "80402" [1]=> string(1) "0" ["fieldtype"]=> string(1) "0" [2]=> string(1) "7" ["oasistype"]=> string(1) "7" [3]=> string(1) "1" ["x"]=> string(1) "1" [4]=> string(1) "0" ["y"]=> string(1) "0" [5]=> string(1) "0" ["occupied"]=> string(1) "0" [6]=> string(2) "o7" ["image"]=> string(2) "o7" [7]=> string(5) "80402" ["wref"]=> string(5) "80402" [8]=> string(1) "7" ["type"]=> string(1) "7" [9]=> string(5) "80802" ["conqured"]=> string(5) "80802" [10]=> string(3) "400" ["wood"]=> string(3) "400" [11]=> string(3) "400" ["iron"]=> string(3) "400" [12]=> string(3) "400" ["clay"]=> string(3) "400" [13]=> string(3) "400" ["maxstore"]=> string(3) "400" [14]=> string(3) "400" ["crop"]=> string(3) "400" [15]=> string(3) "400" ["maxcrop"]=> string(3) "400" [16]=> string(10) "1328870853" ["lastupdated"]=> string(10) "1328870853" [17]=> string(3) "100" ["loyalty"]=> string(3) "100" [18]=> string(1) "5" ["owner"]=> string(1) "5" [19]=> string(14) "Occupied Oasis" ["name"]=> string(14) "Occupied Oasis" }*/
						//echo"kakakakaka;;;";echo $database->checkMyVillages($to['wref'],$session->uid);echo"|||||||||";echo$session->uid;
						if ($database->checkMyData($to['wref'])!=1){
                        $database->addNotice($database->getVillageField($enforce['from'],"owner"),15,'Reinforcement in '.addslashes($to['name']).' was attacked',$data2,$AttackArrivalTime,$ownally,$targetally);
						}
...
//array(11) { [1]=> float(0) [2]=> float(0) [3]=> float(0) [4]=> float(0) [5]=> float(0) [6]=> float(0) [7]=> float(0) [8]=> float(0) [9]=> float(0) [10]=> float(0) [11]=> int(1) }
/*echo"<pre>";
var_dump($battlepart['casualties_attacker']);
echo"</pre>";*/
                    //kill own defence
                    $q = "SELECT * FROM ".TB_PREFIX."units WHERE vref='".$data['to']."'";
                    $unitlist = $database->query_return($q); 
...
//			echo $data['ref'].',11,'.$dead11;
			$database->modifyAttack($data['ref'],11,$dead11);
/*
			if ($data['t11']>=1){
			echo"<pre>";var_dump($data);echo"</pre>";
			$database->modifyHeroAttack($data['ref'],10,$dead10);
			}
*/
			...
			if ($herosend_att>0){
                $qh = "SELECT * FROM ".TB_PREFIX."hero WHERE uid = ".$session->uid; 
...
/*                for($j=19;$j<=40;$j++) {
            ...
            $data_fail = ''.$from['owner'].','.$from['wref'].','.$owntribe.','.$unitssend_att.','.$unitsdead_att.','.$steal[0].','.$steal[1].','.$steal[2].','.$steal[3].','.$battlepart['bounty'].','.$to['owner'].','.$to['wref'].','.addslashes($to['name']).','.$targettribe.',,,0,'.$unitssend_def[1].','.$unitsdead_deff[1].',0,'.$unitssend_def[2].','.$unitsdead_deff[2].',0,'.$unitssend_def[3].','.$unitsdead_deff[3].','.$nat.','.$unitssend_def[4].','.$unitsdead_deff[4].','.$natar.','.$unitssend_def[5].','.$unitsdead_deff[5].',,,';
            ...
            if($scout){
                for($i=1;$i<=10;$i++)
                {
                    if($battlepart['casualties_attacker'][$i]){
                        $database->addNotice($to['owner'],0,''.addslashes($from['name']).' scouts '.addslashes($to['name']).'',$data2,$AttackArrivalTime,$ownally,$targetally,$targetally);
                        break;
                    }
                }
            }
                ...
                if ($totaldead_def == 0){
                $database->addNotice($to['owner'],4,''.addslashes($from['name']).' attacks '.addslashes($to['name']).'',$data2,$AttackArrivalTime,$ownally,$targetally,$targetally);
            }else {
            $database->addNotice($to['owner'],5,''.addslashes($from['name']).' attacks '.addslashes($to['name']).'',$data2,$AttackArrivalTime,$ownally,$targetally,$targetally);
                }
            }    
            //to here
            ...
            if($unitsdead_att != $unitssend_att)
            {
                ...
                if($type == 1) {
                    $database->addNotice($from['owner'],0,''.addslashes($from['name']).' scouts '.addslashes($to['name']).'',$data2,$AttackArrivalTime,$ownally,$targetally,$ownally);
                }else {
                    if ($totaldead_att == 0){
                    $database->addNotice($from['owner'],1,''.addslashes($from['name']).' attacks '.addslashes($to['name']).'',$data2,$AttackArrivalTime,$ownally,$targetally,$ownally);
                    }else{ 
                    $database->addNotice($from['owner'],2,''.addslashes($from['name']).' attacks '.addslashes($to['name']).'',$data2,$AttackArrivalTime,$ownally,$targetally,$ownally);
                    }       
                }
...
//					var_dump($steal);
            ...
            else //else they die and don't return or report.
            {
                $database->setMovementProc($data['moveid']);
                if($type == 1){
                    $database->addNotice($from['owner'],0,''.addslashes($from['name']).' scouts '.addslashes($to['name']).'',$data_fail,$AttackArrivalTime,$ownally,$targetally);
                }else{
                    $database->addNotice($from['owner'],3,''.addslashes($from['name']).' attacks '.addslashes($to['name']).'',$data_fail,$AttackArrivalTime,$ownally,$targetally);
                    }
            }
			...
			if($data['t11'] != 0) {
			    ...
			    if (!isset($check['id'])){
				 ...
				 //add unit.
					 $j='1';
					 for($i=$start;$i<=$end;$i++){
//						echo'$database-modifyEnforce('.$check['id'].','.$i.','.$data['t'.$j.''].',1);';
    ...
    private function returnunitsComplete() {
        ...
        $dataarray = $database->query_return($q);
		//echo "<pre>";var_dump($dataarray);echo"</pre>";
        foreach($dataarray as $data) {
...
//		echo $this->bountyGetCropProd()."-".$this->bountypop."-".$upkeep;
...
//============================================================================
    private function calculateProduction($bountywid,$uid) { 
        global $technology,$database;
        $normalA = $database->getOwnArtefactInfoByType($bountywid,4);  
        $largeA = $database->getOwnUniqueArtefactInfo($uid,4,2);
        $uniqueA = $database->getOwnUniqueArtefactInfo($uid,4,3);
    ...
    private function celebrationComplete() {
        ...
        $varray = $database->getCel(); 
            foreach($varray as $vil){
               ...
               // $database->setCelCp($user,$cp); fix party
                $database->setCelCp($id,$cp);
            }
    }
        ...
        if(!empty($harray)) { 
            foreach($harray as $hdata) { 
                if((time()-$hdata['lastupdate'])>=120) { 
                    if($hdata['health']<100) { 
                        $database->modifyHero("health",$hdata['health']+($hdata['regeneration']*0.5/(24*60*60)*((time()-$hdata['lastupdate'])/(24*60*60))),$hdata['heroid']); 
                    } 
                    if($hdata['health']>100) { 
...
//		var_dump($herodata);
//		echo"</pre>";
//echo $herodata[0]['trainingtime'].' <= '.time();
